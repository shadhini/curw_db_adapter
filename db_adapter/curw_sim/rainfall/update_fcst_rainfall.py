    ...
    try:
        ...
        for obs_id in obs_stations_dict.keys():
            ...
            for i in range(len(model_list)):
                ...
                if i==0:
                    print("i==0: temp :", meta_data['grid_id'], len(temp_timeseries), temp_timeseries[0][0], temp_timeseries[-1][0])
                    fcst_timeseries = temp_timeseries
                else:
                    print("i!=0: fcst :", meta_data['grid_id'], len(fcst_timeseries), fcst_timeseries[0][0], fcst_timeseries[-1][0])
                    print("i==0: temp :", meta_data['grid_id'], len(temp_timeseries), temp_timeseries[0][0], temp_timeseries[-1][0])
