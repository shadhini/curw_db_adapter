...
class Run_Mean(CurwSimBase):
    __tablename__ = 'run_mean'
    ...
    grid_relationship = relationship('Grid_Map', foreign_keys='Run_Mean.grid_id', back_populates="run_relationship")
...
class Data(CurwSimBase):
    ...
    id_relationship = relationship('Run_Mean', foreign_keys='Data.id', back_populates="data_relationship")
...
class Grid_Map(CurwSimBase):
    ...
    run_relationship = relationship("Run_Mean", back_populates="grid_relationship", cascade="all, delete, delete-orphan")
